...
The `dotenv-ng` project adheres to the [Rust Code of
Conduct](https://www.rust-lang.org/policies/code-of-conduct).

## Issues

Please feel free to open new issues or comment on existing ones. If you would like to attempt
...
and dependencies in the dotenv-ng repository.
...
Enter the reproducible development environment and run the complete local CI
suite with:
...
If your contribution changes the behavior of dotenv-ng, please update the
